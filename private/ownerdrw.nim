...
proc destroywxOwnerDrawnBase*(this: var WxOwnerDrawnBase) {.cdecl,
    importcpp: "#.~wxOwnerDrawnBase()", header: wxh.}
proc setFont*(this: var WxOwnerDrawnBase; font: WxFont) {.cdecl, importcpp: "SetFont",
    header: wxh.}
...
proc setBackgroundColour*(this: var WxOwnerDrawnBase; colBack: WxColour) {.cdecl,
    importcpp: "SetBackgroundColour", header: wxh.}
proc getBackgroundColour*(this: WxOwnerDrawnBase): var WxColour {.noSideEffect, cdecl,
...
proc setOwnerDrawn*(this: var WxOwnerDrawnBase; ownerDrawn: bool = true) {.cdecl,
    importcpp: "SetOwnerDrawn", header: wxh.}
type
...
type
  WxODStatus* {.size: sizeof(cint), importcpp: "wxOwnerDrawnBase::wxODStatus",
               header: wxh.} = enum
    wxODSelected = 0x00000001, wxODGrayed = 0x00000002, wxODDisabled = 0x00000004,
    wxODChecked = 0x00000008, wxODHasFocus = 0x00000010, wxODDefault = 0x00000020,
    wxODHidePrefix = 0x00000100


proc onMeasureItem*(this: var WxOwnerDrawnBase; width: ptr csize; height: ptr csize): bool {.
    cdecl, importcpp: "OnMeasureItem", header: wxh.}
proc onDrawItem*(this: var WxOwnerDrawnBase; dc: var WxDC; rc: WxRect; act: WxODAction;
                stat: WxODStatus): bool {.cdecl, importcpp: "OnDrawItem", header: wxh.}